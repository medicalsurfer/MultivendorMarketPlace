...
<head>
    ...
    <link rel="stylesheet" href="<?= $B ?>/assets/css/style.css?v=8">
</head>
<body>
    ...
    <div class="navbar-inner">
        ...
        <div class="nav-products <?= $currentPage === 'index' ? 'active' : '' ?>">
            ...
            <div class="nav-products-dropdown">
                ...
                <div class="nav-dropdown-grid">
                    <a href="<?= $B ?>/index.php" class="nav-dropdown-item">
                    ...
                    <a href="<?= $B ?>/index.php?cat=deals" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=electronics" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=fashion" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=gaming" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=sport" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=health-wellness" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=home" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=music" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=art" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php?cat=crypto" class="nav-dropdown-item">
                        <span class="nav-dropdown-icon">
                    ...
                    <a href="<?= $B ?>/index.php" class="nav-dropdown-item nav-dropdown-viewall">
                        <span class="nav-dropdown-icon">
        ...
        <nav class="nav-actions">
            ...
            <button class="theme-toggle" onclick="toggleTheme()" title="Toggle dark/light theme" aria-label="Toggle theme">
                <svg class="icon-moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                <svg class="icon-sun" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
            </button>
